...
char *astringa(oggetto *o){ // funzione generica che chiama quella della classe!
   classe *cla = o->myclass;
   return cla->astringa(o->ob);
}


void *esegui(oggetto *o, char *met){ // funzione generica che chiama quella della classe!
   classe *cla = o->myclass;
   for (int i=0;i<10;i++){
